			...
			<div class="card">
				...
				<div class="card-body">
					<div class="form-group">
						...
						<input type="text" name="metadata[site_name]" required="" value="{{ $contents->site_name ?? '' }}" class="form-control text-white">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="text" name="metadata[matatag]" required="" value="{{ $contents->matatag ?? '' }}" class="form-control text-white">
					</div>
					@if(isset($contents->twitter_site_title))
					<div class="form-group">
						<label>{{ __('Twitter Site Title') }}</label>
						<input type="text" name="metadata[twitter_site_title]" required="" value="{{ $contents->twitter_site_title ?? '' }}" class="form-control text-white">
					</div>
					@endif
					<div class="form-group">
						<label>{{ __('Meta Image') }}</label>
						<input type="file" accept="image/*" name="image"  class="form-control text-white">
					</div>
