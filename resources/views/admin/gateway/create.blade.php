			...
			<div class="card">
				<div class="card-body">
					...
					<div class="form-group mb-4">
						...
						<input type="file" id="logo" class="form-control text-white" name="logo" accept="image/*">
												
					</div>
					<div class="form-group mb-4">
						<label class="col-form-label text-md-right required" for="currency">{{ __('Currency') }}</label>
						<input type="text" class="form-control text-white" name="currency" id="currency"  required>
					</div>
					
					<div class="form-group mb-4">
						<label class="col-form-label text-md-right required" for="min_amount">{{ __('Minimum Amount') }}</label>
						<input type="number" name="min_amount" id="min_amount" step="any"  class="form-control text-white" placeholder="{{ __("Minimum transaction amount") }}" required>
					</div>
					<div class="form-group mb-4">
						<label class="col-form-label text-md-right required" for="max_amount">{{ __('Maximum Amount') }}</label>
						<input type="number" name="max_amount" id="max_amount" step="any"  class="form-control text-white" placeholder="{{ __("Maximum transaction amount") }}" required>
					</div>
					<div class="form-group mb-4">
						<label class="col-form-label text-md-right required" for="charge">{{ __('Gateway Charge') }}</label>
						<input type="number" step="any" class="form-control text-white" name="charge" id="charge"  required value="0">
					</div>
					<div class="form-group mb-4">
						<label class="col-form-label text-md-right required" for="multiply">{{ __('Multiply from base currency') }}</label>
						<input type="number" step="any" class="form-control text-white" name="multiply" id="multiply"  required value="0">
					</div>
					
					<div class="form-group mb-4">
						<label class="col-form-label text-md-right required" for="status">{{ __('Payment Instruction') }}</label>
						<textarea class="form-control text-white" maxlength="1000" name="comment"></textarea>
					</div>
					<div class="form-group mb-4">
