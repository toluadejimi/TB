            ...
            <div class="card col-lg-4 mx-auto">
              ...
              @endif
                ...
                @csrf
                  ...
                  <p class="text-left mb-3">Wait for about 5mins, If code is not in INBOX, Kindly check your spam folder for OTP code. <br><a href="verify-code">Request another code</a></p>
