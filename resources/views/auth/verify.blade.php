              ...
              @endif
                ...
                @csrf
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" placeholder="Enter OTP code here" name="code" required class="form-control p_input">
                  ...
                  <p class="text-left mb-3">Wait for about 5mins, If code is not in INBOX, Kindly check your spam folder for OTP code. <br><a href="resend-code">Request another code</a></p>
