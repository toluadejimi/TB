...
<div class="col-sm-12">
   ...
   <form class="installer_form_instant_reload" method="post" action="{{ route('install.store') }}">
      ...
      <div class="form-group mt-5">
         ...
         <input type="text" name="site_name" class="form-control text-white" required="" placeholder="WASender" maxlength="20">
      </div>
      <div class="form-group mb-2">
         <label>{{ __('Database Connection Driver') }}</label>
         <input type="text" name="db_connection" class="form-control text-white" required="" placeholder="mysql" maxlength="20" value="mysql">
      </div>
      <div class="form-row">
         <div class="col-sm-6">
            <div class="form-group">
               <label>{{ __('Database Host') }}</label>
               <input type="text" name="db_host" class="form-control text-white" required="" placeholder="localhost" maxlength="20" value="localhost">
            </div>
         </div>
         <div class="col-sm-6">
            <div class="form-group">
               <label>{{ __('Database Port') }}</label>
               <input type="number" name="db_port" class="form-control text-white" required="" placeholder="3306" maxlength="20" value="3306">
            </div>
         </div>
      </div>
      <div class="form-group">
         <label>{{ __('Database Name') }}</label>
         <input type="text" name="db_name" class="form-control text-white" required="" placeholder="Enter Your Database Name">
      </div>
      <div class="form-group">
         <label>{{ __('Database Username') }}</label>
         <input type="text" name="db_user" class="form-control text-white" required="" placeholder="Enter Your Database Username">
      </div>
      <div class="form-group">
         <label>{{ __('Database Password') }}</label>
         <input type="text" name="db_pass" class="form-control text-white"  placeholder="Enter Your Database Password">
